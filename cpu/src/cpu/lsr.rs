...
impl CPU {
    pub(super) fn LSR(&mut self, mode: AddressingMode, data: &mut CPUData) {
        fn flags(res: u16, cpu: &mut CPU) {
            cpu.ps.set(StatusFlag::Z, (res & 0xFF) == 0);
            cpu.ps.set(StatusFlag::N, (res & 0x80) > 0);
        }

        fn shift_right(cpu: &mut CPU, data: &mut CPUData) {
...
mod tests {
    ...
    fn LSR_A() {
        ...
        data.mem.data[0x0000] = opcode::LSR_AC;
    ...
    fn LSR_ZP() {
        ...
        assert_eq!(data.mem.data[0x00AB], 0x09);
        assert!(cpu.ps.is_empty());
    ...
    fn LSR_ZPX() {
        ...
        data.mem.data[0x0000] = opcode::LSR_ZPX;
        data.mem.data[0x0001] = 0xAB;
        ...
        assert_eq!(data.mem.data[0x00B0], 0x09);
        assert!(cpu.ps.is_empty());
        assert_eq!(cpu.pc, 0x0002);
    }
    ...
    fn INC_ABS() {
        ...
        assert_eq!(data.mem.data[0xD007], 0x09);
        assert!(cpu.ps.is_empty());
    ...
    fn INC_ABX() {
        ...
        data.mem.data[0x0000] = opcode::LSR_ABX;
        data.mem.data[0x0001] = 0x07;
        data.mem.data[0x0002] = 0xD0;
        ...
        assert_eq!(data.mem.data[0xD010], 0x09);
        assert!(cpu.ps.is_empty());
        assert_eq!(cpu.pc, 0x0003);
    }
}
