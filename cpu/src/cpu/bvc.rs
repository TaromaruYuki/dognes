...
impl CPU {
    pub(super) fn BVC(&mut self, data: &mut CPUData) {
        let map = addressing::branch_clear(self.ps.contains(StatusFlag::V));
...
mod tests {
    ...
    fn BVC_SET() {
        ...
        data.mem.data[0x0000] = opcode::BVC;
    ...
    fn BVC_UNSET_4_CYCLES() {
        ...
        data.mem.data[0x00FD] = opcode::BVC;
