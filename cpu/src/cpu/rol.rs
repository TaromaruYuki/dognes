...
impl CPU {
    pub(super) fn ROL(&mut self, mode: AddressingMode, data: &mut CPUData) {
        ...
        fn rotate_left(cpu: &mut CPU, data: &mut CPUData) {
            let res = (data.pins.data as u16) << 1 | (cpu.ps.contains(StatusFlag::C) as u16);
            flags(res, cpu);
        ...
        match mode {
            AddressingMode::Accumulator => {
                ...
                map.insert(0, |cpu, _| {
                    let res = (cpu.a as u16) << 1 | (cpu.ps.contains(StatusFlag::C) as u16);
                    flags(res, cpu);
...
mod tests {
    ...
    fn ROL_A() {
        ...
        data.mem.data[0x0000] = opcode::ROL_AC;
    ...
    fn ROL_ZP() {
        ...
        data.mem.data[0x0000] = opcode::ROL_ZP;
        ...
        assert_eq!(data.mem.data[0x00AB], 0x25);
        assert!(cpu.ps.is_empty());
    ...
    fn ROL_ZPX() {
        ...
        data.mem.data[0x0000] = opcode::ROL_ZPX;
        data.mem.data[0x0001] = 0xAB;
        ...
        assert_eq!(data.mem.data[0x00B0], 0x25);
        assert!(cpu.ps.is_empty());
        assert_eq!(cpu.pc, 0x0002);
    }
    ...
    fn INC_ABS() {
        ...
        data.mem.data[0x0000] = opcode::ROL_ABS;
        ...
        assert_eq!(data.mem.data[0xD007], 0x25);
        assert!(cpu.ps.is_empty());
    ...
    fn INC_ABX() {
        ...
        data.mem.data[0x0000] = opcode::ROL_ABX;
        data.mem.data[0x0001] = 0x07;
        data.mem.data[0x0002] = 0xD0;
        ...
        assert_eq!(data.mem.data[0xD010], 0x25);
        assert!(cpu.ps.is_empty());
        assert_eq!(cpu.pc, 0x0003);
    }
}
