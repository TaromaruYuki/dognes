...
impl CPU {
    pub(super) fn ORA(&mut self, mode: AddressingMode, data: &mut CPUData) {
        fn or_a_and_data(cpu: &mut CPU, data: &mut CPUData) {
        ...
        match mode {
            ...
            AddressingMode::AbsoluteX => {
                ...
                map.insert(3, |cpu, data| {
                    addressing::methods::get_data_or_return(cpu, data, or_a_and_data)
                });
                map.insert(4, or_a_and_data);
            ...
            AddressingMode::IndirectIndexed => {
                ...
                map.insert(4, |cpu, data| {
                    addressing::methods::store_if_overflow_or_end(cpu, data, or_a_and_data);
                });
                map.insert(5, or_a_and_data);
...
mod tests {
    ...
    fn ORA_IM() {
        ...
        data.mem.data[0x0000] = opcode::ORA_IM;
    ...
    fn ORA_ZP() {
        ...
        data.mem.data[0x0000] = opcode::ORA_ZP;
    ...
    fn ORA_ZPX() {
        ...
        data.mem.data[0x0000] = opcode::ORA_ZPX;
        data.mem.data[0x0001] = 0x12;
    ...
    fn ORA_ABS() {
        ...
        data.mem.data[0x0000] = opcode::ORA_ABS;
    ...
    fn ORA_ABX() {
        ...
        data.mem.data[0x0000] = opcode::ORA_ABX;
        data.mem.data[0x0001] = 0x09;
        data.mem.data[0x0002] = 0xD0;
    ...
    fn ORA_ABY() {
        ...
        data.mem.data[0x0000] = opcode::ORA_ABY;
        data.mem.data[0x0001] = 0x09;
        data.mem.data[0x0002] = 0xD0;
        data.mem.data[0xD00E] = 0xCD;
    ...
    fn ORA_INX() {
        ...
        data.mem.data[0x0000] = opcode::ORA_INX;
        data.mem.data[0x0001] = 0xCD;
    ...
    fn ORA_INY() {
        ...
        data.mem.data[0x0000] = opcode::ORA_INY;
        data.mem.data[0x0001] = 0xCD;
