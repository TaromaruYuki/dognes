...
impl CPU {
    pub(super) fn STX(&mut self, mode: AddressingMode, data: &mut CPUData) {
        let finish: addressing::CaseFunction = |cpu, _| cpu.instruction_finish();
        match mode {
            AddressingMode::ZeroPage => {
                let mut map = addressing::zero_page();
                map.insert(1, addressing::methods::store_zero_page_x);
                map.insert(2, finish);
            ...
            AddressingMode::ZeroPageY => {
                ...
                map.insert(2, addressing::methods::store_zero_page_temp_x);
                map.insert(3, finish);
...
mod tests {
    ...
    fn STX_ZP() {
        ...
        data.mem.data[0x0000] = opcode::STX_ZP;
    ...
    fn STX_ZPY() {
        ...
        data.mem.data[0x0000] = opcode::STX_ZPY;
        data.mem.data[0x0001] = 0xCD;
    ...
    fn STX_ABS() {
        ...
        data.mem.data[0x0000] = opcode::STX_ABS;
